  ...
  return (
    <ol className='rounded-md bg-white lg:flex lg:rounded-none lg:border-1 lg:border-r lg:border-gray-200'>
        {STEPS.map((step, i)=>{
            ...
            return <li key={step.name} className='relative overflow-hidden flex-1'>
                <div>
                ...
                <span className={cn(i !== 0 ? 'lg:pl-9' : '', 'flex flex-col lg:flex-row items-center px-6 py-4 text-sm font-medium')}>
                    <span className='flex-shrink-0'>
                        <Image
                            ...
                            className={cn(
                                'h-20 w-20 object-contain items-center justify-center',
                                {
